import { ApplicationLayout, EntitySelection, Graph, selectedNodes } from "@neo4j-arrows/model";
...
export const getSelectedNodes = ({graph, gangs, selection, applicationLayout}:GetSelectedNodesArgs) => {
