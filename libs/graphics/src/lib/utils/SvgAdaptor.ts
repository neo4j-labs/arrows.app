...
export class SvgAdaptor implements DrawingContext {
  ...
  constructor(width:number, height:number) {
    ...
    this.measureTextContext = canvas.getContext('2d') as CanvasRenderingContext2D // ABK: should never be null, right?
    this.beginPath()
  }
...
const newElement = (tagName:string, attributes:Record<string,string|number> = {}) => {
