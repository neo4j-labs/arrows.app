...
export class ParallelArrow {
  ...
  constructor(startCentre:Point, endCentre:Point, startRadius:number, endRadius:number, startDeflection:number, 
    endDeflection:number, displacement:number, arcRadius:number, dimensions:ArrowDimensions) 
    {
