...
export default class Gestures {
  ...
  draw (ctx:DrawingContext, displayOptions:DisplayOptions) {
    ...
    const drawNewNodeAndRelationship = (sourceNodeId:string, targetNodeId:string|null, newNodeNaturalPosition:Point) => {
      ...
      if (sourceNode) {
        ...
        const targetNode = (targetNodeId !== null) ? visualGraph.nodes[targetNodeId] : undefined;
