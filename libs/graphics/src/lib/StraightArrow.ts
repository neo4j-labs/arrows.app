...
export class StraightArrow {
  ...
  constructor(startCentre:Point, endCentre:Point, startAttach:Point, endAttach:Point, dimensions:ArrowDimensions) {
...
export const normalStraightArrow = (startCentre:Point, endCentre:Point, startRadius:number, endRadius:number, dimensions:ArrowDimensions) => {
  const interNodeVector = endCentre.vectorFrom(startCentre)
