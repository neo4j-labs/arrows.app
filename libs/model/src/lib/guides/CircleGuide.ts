...
export class CircleGuide {
  ...
  get type() { // ABK: Typescript can't discriminate on this
    return 'CIRCLE'
  }
  ...
  combine(otherGuide:AnyGuide, naturalPosition:Point) {
    switch (otherGuide.type) {
      case 'LINE':
        return intersectLineAndCircle(otherGuide as LineGuide, this, naturalPosition)

      case 'CIRCLE':
        return intersectCircleAndCircle(this, otherGuide as CircleGuide, naturalPosition)
