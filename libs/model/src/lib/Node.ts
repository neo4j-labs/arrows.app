...
export const translate = (node:Node, vector:Vector) => moveTo(node, node.position.translate(vector))
...
export const isNode = (entity:unknown): entity is Node =>
  (entity !== null) && (typeof entity === 'object') && Object.hasOwn(entity,'caption') && Object.hasOwn(entity, 'position')